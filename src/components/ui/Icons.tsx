...
export const UsersIcon = ({ size = 18, className }: P) => (
  <svg {...base(size, className)} strokeWidth={1.9}>
    ...
    <path d="M15.6 14.5a4.6 4.6 0 0 1 5.4 4.5" />
  </svg>
);

/* نمودار درختی: یک گره بالا که به دو گره پایین شاخه می‌دهد */
export const TreeIcon = ({ size = 18, className }: P) => (
  <svg {...base(size, className)} strokeWidth={1.9}>
    <rect x="8.5" y="3" width="7" height="5" rx="1.4" />
    <rect x="3" y="16" width="7" height="5" rx="1.4" />
    <rect x="14" y="16" width="7" height="5" rx="1.4" />
    <path d="M12 8v4M6.5 16v-2.2a1.8 1.8 0 0 1 1.8-1.8h7.4a1.8 1.8 0 0 1 1.8 1.8V16" />
  </svg>
);
