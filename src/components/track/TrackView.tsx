...
interface Props {
  ...
  /** بخش‌های اختصاصی خانهٔ مسیر (مثل «قبل از شروع» داکر)، اگر نوشته شده باشد */
  extra?: string | null;
}

export default function TrackView({ track, categoryName, extra }: Props) {
  ...
  return (
    <AppShell crumbs={[
      ...
      {/* محتوای خود پروژه است، نه ورودی کاربر */}
      {extra && <div className="prose" dangerouslySetInnerHTML={{ __html: extra }} />}
