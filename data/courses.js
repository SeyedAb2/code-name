...
["10","10-health.html",0,18,70,"healthcheck، restart policy، لاگ","کانتینری که بالا است اما کار نمی‌کند؛ و چطور داکر خودش بفهمد.","Healthchecks, restart policies, logging","A container that is up but not working — and how Docker can tell.","healthcheck restart unless-stopped log driver rotation"],
